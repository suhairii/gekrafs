...
<body>
	...
	<br><br>
	<div class="container">
		<h2 class="text-center mb-3">Tambah Edukasi</h2>
		<form action="act_edukasi.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label">Nama</label>
				<input type="text" name="nama" class="form-control bg-light" id="exampleInputEmail1" aria-describedby="emailHelp">
				<input type="hidden" class="form-control" name="id_edukasi" required="required"></input>
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" name="jabatan" required="required"></input>
			</div>
			<div class="mb-3">
