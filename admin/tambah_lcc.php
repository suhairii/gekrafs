...
<body>
    ...
    <div class="container">
        <h2 class="text-center mb-3">Tambah LCC</h2>
        <form action="act_lcc.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="nama" class="form-label">Judul</label>
                <input type="text" name="nama   " class="form-control bg-light" id="nama">
            </div>
            <div class="mb-3">
                <label for="is" class="form-label">Isi Sumber</label>
