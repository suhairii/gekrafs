...
<body>
    ...
    <div class="container">
        ...
        ?>
        <br>
        <a href="tambah_community.php" class="btn btn-info btn-sm">Tambah Data</a>
        <br>
        <br>
        <table class="table table-bordered horizontal-scrollable">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_community.php?id_community=<?php echo $d['id_community']; ?>"><span class="badge text-bg-primary">Edit</span></a>
                        <a href="hapus.php?id_community=<?php echo $d['id_community']; ?>"><span class="badge text-bg-danger">Hapus</span></a>
                    </td>
                </tr>
            <?php
            }
