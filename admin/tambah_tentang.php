...
<body>
	...
	<br><br>
	<div class="container">
		<h2 class="text-center mb-3">Tambah tentang</h2>
		<form action="act_tentang.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<input type="hidden" class="form-control" name="id_tentang" required="required"></input>
