...
<body>
	...
	<br><br>
	<div class="container">
		<h2 class="text-center mb-3">Tambah Pariwisata</h2>
		<form action="act_pariwisata.php" method="POST" enctype="multipart/form-data">
			<input type="hidden" class="form-control" name="id_ekraf" required="required"></input>
			<div class="mb-3">
				<label for="nama" class="form-label">Nama</label>
				<input type="text" class="form-control ckeditor" name="nama" id="nama"></input>
			</div>
			<div class="mb-3">
