...
<body>
	...
	<div class="container px-5">
		<h2 class="text-center mb-3">Edit community</h2>
		<?php
		include '../config/koneksi.php';
		$id = $_GET['id_community'];
		$data = mysqli_query($koneksi, "select * from community where id_community='$id'");
		while ($d = mysqli_fetch_array($data)) {
		?>
			<form action="update_community.php" method="POST" enctype="multipart/form-data">
				<div class="mb-3">
					<input type="hidden" name="id_community" value="<?php echo $d['id_community']; ?>">
