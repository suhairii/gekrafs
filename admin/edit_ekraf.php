...
<body>
	...
	<div class="container px-5">
		<h2 class="text-center mb-3">Edit ekraf</h2>
		<?php
		include '../config/koneksi.php';
		$id = $_GET['id_ekraf'];
		$data = mysqli_query($koneksi, "select * from ekraf where id_ekraf='$id'");
		while ($d = mysqli_fetch_array($data)) {
		?>
			<form action="update_ekraf.php" method="POST" enctype="multipart/form-data">
				<div class="mb-3">
					<input type="hidden" name="id_ekraf" value="<?php echo $d['id_ekraf']; ?>">
				...
				<div class="mb-3">
					...
					<input class="form-control ckeditor" name="judul" value="<?php echo $d['judul']; ?>"></input>
				</div>
				<div class="mb-3">
