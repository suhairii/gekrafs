...
<body>
	...
	<br><br>
	<div class="container">
		<h2 class="text-center mb-3">Tambah Community</h2>
		<form action="act_community.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label">Judul</label>
				<input type="text" name="judul" class="form-control bg-light" id="exampleInputEmail1" aria-describedby="emailHelp">
				<input type="hidden" class="form-control" name="id_community" required="required"></input>
			</div>
			<div class="mb-3">
