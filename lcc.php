        ...
        <div class="row">
          ...
          ?>
            <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left">
              <img src="admin/gambar/<?php echo $d['foto'] ?>" class="mb-3" alt="Deskripsi Gambar" width="400" height="auto">
            </div>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="row">
          ...
          while ($d = mysqli_fetch_array($data)) {
          ?>
            <div class="col-lg-4 col-md-3 mb-4 justify-content-center" data-aos="200">
              <!-- <div class="icon-box"> -->
              <img src="admin/gambar/<?php echo $d['foto'] ?>" class="mb-3" alt="Deskripsi Gambar" width="300" height="300">
